...
namespace DLTD.GestionPm.API.Controllers
{
    ...
    {
        private readonly ITipoActividadService _service;

        public TipoActividadController(ITipoActividadService service)
        {
            _service = service;
        }

        [HttpPost]
        public async Task<IActionResult> Post([FromBody] TipoActividadRequest request)
        {
        ...
        [HttpPut("{id:int}")]
        public async Task<IActionResult> Put(int id, [FromBody] TipoActividadRequest request)
        {
